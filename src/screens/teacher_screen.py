...
def teacher_screen_login():
     ...
     st.space()
     teacher_username = st.text_input("Enter Username",placeholder='saikalyan04')
...
def register_teacher(teacher_username,teacher_name,teacher_pass,teacher_pass_confirm):
    ...
    if teacher_pass != teacher_pass_confirm:
        return False,"Password doesn't Matched"
...
def teacher_screen_register():
     ...
     st.space()
     teacher_username = st.text_input("Enter Username",placeholder='saikalyan04')
     teacher_name = st.text_input("Enter Name",placeholder='Sai Kalyan')
     teacher_pass = st.text_input("Enter Password",type='password',placeholder='Enter Password')
     ...
     with btnc1:
         if st.button("Register",shortcut="control+enter",width='stretch'):
