...
def student_screen():
    ...
    photo_source = st.camera_input("Login Using Face ID - Position Your Face in the center")
    if photo_source:
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter Your Name",placeholder='Amithab Bachhan')
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I am present, My name is Bacchhan")
